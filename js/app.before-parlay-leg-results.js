        ...
        const timer =
            setInterval(() => {
                ...
                if (result.won) {
                    ...
                    message.textContent =
                        `PARLAY WON · STAKE ${result.stake.toLocaleString()} · RETURN ${result.payout.toLocaleString()} · PROFIT +${result.net.toLocaleString()} · BALANCE ${result.coins.toLocaleString()}`;

                } else {

                    message.textContent =
                        `PARLAY LOST · STAKE ${result.stake.toLocaleString()} · LOSS -${Math.abs(result.net).toLocaleString()} · BALANCE ${result.coins.toLocaleString()}`;
