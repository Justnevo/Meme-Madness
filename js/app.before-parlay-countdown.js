        ...
        if (placeParlayButton) {
            ...
            placeParlayButton.addEventListener(
                ...
                () => {
                    ...
                    /*
                     * Placement is now successful.
                     *
                     * The stake is deducted exactly once.
                     * Settlement/payout will be connected next.
                     */

                    if (message) {

                        message.textContent =
                            `PARLAY PLACED · ${parlayLegs.length} LEGS · ${stake.toLocaleString()} COINS STAKED.`;
                    }
